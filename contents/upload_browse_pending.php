...
<p id="pageTitle" hidden>&nbsp;&nbsp;Browse Penerimaan Pending</p>
...
<script>
    $(document).ready(function() {
        var t = $('#app-tb1').DataTable( {
            "ajax": {
            	"url": "ajax/ajax_upload_browse_pending.php",
            	"type": "POST"
            },
            oLanguage: {
                ...
                { "data": "jum_dokumen"},
                {
                	...
                	render: function ( data, type, row, full, meta ) {
                        ...
                        var pib_tanggal_x = data.pib_tanggal_x;
         				return '<div class="pending_link" pib_nomor="'+pib_nomor+'" pib_tanggal="'+pib_tanggal_x+'">PERIKSA</div>';
        ...
        $(document).on("click", ".pending_link", function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    console.log(data);
                    var pagex = 'upload_browse_pending_detil';
