<style type="text/css">
    .status_detil_link_erk {
        color: blue;
        cursor: pointer;
    }
</style>

<p id="pageTitle" hidden>&nbsp;&nbsp;Edit Remove Kirim</p>
...
$data = $apps->getDocsAllByIdStatus1($user_id);
        ...
        <tbody>
            <?php if ($data == true) { 
                    ...
                    <tr>
                        ...
                        <td><div class="status_detil_link_erk" pib_nomor="<?php echo $r['pib_nomor'] ?>" pib_tanggal="<?php echo $r['pib_tanggal_x'] ?>">VIEW DETIL</div></td>
                    </tr>
            <?php $no++; } } else {  } ?>
...
<script type="text/javascript">
    ...
    $(document).on("click", ".status_detil_link_erk", function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                console.log(data);
                var pagex = 'upload_edit_rem_kirim_detil';
