...
$data = $apps->getDocsKonfByPfpdId($user_id);
        ...
        <tbody>
            <?php if ($data == true) { 
                    ...
                    <tr>
                        ...
                        <?php if ($r['status'] === '0') { ?>
                            <td><div class="konfirmasi_pfpd_r unread" konf_id="<?php echo $r['konf_id'] ?>" pib_nomor="<?php echo $r['pib_nomor'] ?>" pib_tanggal="<?php echo $r['pib_tanggal'] ?>"> &nbsp;UNREAD</div></td>
                        <?php } ?>
                        <?php if ($r['status'] === '1') { ?>
                            <td><div class="konfirmasi_pfpd_r read" konf_id="<?php echo $r['konf_id'] ?>" pib_nomor="<?php echo $r['pib_nomor'] ?>" pib_tanggal="<?php echo $r['pib_tanggal'] ?>"> &nbsp;READ</div></td>
                        <?php } ?>
